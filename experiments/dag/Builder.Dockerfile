...
ADD dag_experiment_runner.py /root/dag_experiment_runner.py


CMD python3 /root/dag_experiment_runner.py --project ${PROJECT} --org ${ORG} --target ${BUILD_TARGET} --commit ${COMMIT}
